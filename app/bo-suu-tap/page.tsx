...
const collections = [
  { id: 'nha-pho-5m', name: 'Nhà phố 5m', query: 'Nhà phố', description: 'Mặt bằng tối ưu cho lô đất đô thị ngang 5m.', image: 'https://static.kienviet.net/storage/uploads/2025/01/rio-house-nha-pho-huong-tay-voi-vuon-cay-xanh-mat-hava-studio_2.jpg' },
  { id: 'biet-thu-2-tang', name: 'Biệt thự 2 tầng', query: 'Biệt thự', description: 'Hồ sơ kiến trúc và kết cấu biệt thự hai tầng.', image: 'https://3adesign.vn/wp-content/uploads/mat-tien-nha-dep-anh-minh-long-thanh-3-3.jpg' },
  { id: 'nha-cap-4-dep', name: 'Nhà cấp 4 đẹp', query: 'Nhà cấp 4', description: 'Giải pháp một tầng thực dụng, dễ thi công.', image: 'https://static-2.happynest.vn/storage/uploads/2022/11/nha-pho-co-gara-de-xe-21-1667295187.jpg' },
  { id: 'nha-xuong-tieu-chuan', name: 'Nhà xưởng tiêu chuẩn', query: 'Nhà xưởng', description: 'Bản vẽ công nghiệp, kết cấu và biện pháp thi công.', image: 'https://static.kienviet.net/storage/uploads/2024/06/kienviet-a2-house28-1718640013.jpg' },
  { id: 'file-ket-cau-hay', name: 'File kết cấu hay', query: 'Kết cấu', description: 'Thuyết minh, bản tính và bản vẽ kết cấu chọn lọc.', image: 'https://static.kienviet.net/storage/uploads/2025/01/kienviet-top10-house-rio-house-kientruchava-1-1736927162.jpg' },
  { id: 'ho-so-mep', name: 'Hồ sơ MEP', query: 'MEP', description: 'Điện, nước và hệ thống kỹ thuật công trình.', image: 'https://static.kienviet.net/storage/uploads/2024/06/kienviet-a2-house28-1718640013.jpg' },
  { id: 'noi-that', name: 'Thiết kế nội thất', query: 'Nội thất', description: 'Hồ sơ bố trí, chi tiết và mô hình nội thất.', image: 'https://static-2.happynest.vn/storage/uploads/2022/11/nha-pho-co-gara-de-xe-21-1667295187.jpg' },
  { id: 'mien-phi', name: 'Bản vẽ miễn phí', query: 'miễn phí', description: 'Tài nguyên có thể tải miễn phí từ cộng đồng.', image: 'https://static.kienviet.net/storage/uploads/2025/01/rio-house-nha-pho-huong-tay-voi-vuon-cay-xanh-mat-hava-studio_2.jpg', free: true },
];
...
async function collectionData() {
  ...
  return Promise.all(collections.map(async collection => {
    ...
    return {...collection,count:Number(row?.total||0),cover:row?.cover_id?`/api/assets/${row.cover_id}`:collection.image};
  }));
}
